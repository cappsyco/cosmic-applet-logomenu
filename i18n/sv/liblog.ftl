...
about = Om
add-divider = Lägg till avdelare
add-menu-item = Lägg till menyalternativ
app-title = COSMIC™ logotyp-meny
cancel = Avbryt
command = Kommando
...
power-help-text = Ange ett av följande kommandon för motsvarande strömåtgärd: Lås, Logga ut, Suspendera, Starta om eller Stäng av
remove = Ta bort
...
select-custom-logo = Välj anpassad logotyp
type = Typ
